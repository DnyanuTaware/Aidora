            ...
            <div className="w-full md:w-3/4">
              ...
              <form onSubmit={submitHandler} method="POST">
                ...
                <div className="text-center mt-7">
                  <button className="px-24 md:px-[118px] lg:px-[140px] py-2  my-4 rounded-md text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 text-white font-medium py-3 rounded-lg hover:from-teal-500 hover:via-teal-600 hover:to-teal-700 transition-all shadow-md hover:cursor-pointer">
                    Register
                  </button>
                </div>
              </form>
